...
const ABOUT_GAME_SUBMENU: MenuItem[] = [GAME_HISTORY, GAME_RULES]
const NFL_SUBMENU: MenuItem[] = [NFL_HISTORY, LEAGUE_STRUCTURE, SEASON_STRUCTURE, DRAFT]
const SUPERBOWL_SUBMENU: MenuItem[] = [SUPERBOWL_WHAT_IS, SUPERBOWL_CHAMPIONS]
const TEAMS_SUBMENU: Team[] = TEAMS

const SUBMENU_ITEMS: (MenuItem[] | Team[]) = [ABOUT_GAME_SUBMENU, NFL_SUBMENU, TEAMS_SUBMENU, SUPERBOWL_SUBMENU]
